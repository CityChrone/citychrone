...
const ICSA = function (point, Tpoint, Tstop, arrayN, arrayC, startTime) {
	...
	//console.log('point', posPoint, P2PPos.length, P2SPos.length, arrayC.length, startTime, Tpoint[posPoint])
	...
	//console.log("P2PPos");
	//console.log(' Tpoint.length', Tpoint.length, P2SPos.length)
	...
	// console.log('stop', P2SPos[posPoint])
	...
	//console.log('arrayC after')
	//console.log('Tpoint before', Tpoint.length, P2SPos.length)
	for (var point_i = 0, len_point = Tpoint.length; point_i < len_point; point_i++) {
		//if (P2SPos[point_i]) {
		//console.log(point_i)
		//console.log(P2SPos[point_i])
		//if (!(point_i in P2SPos)) {
		//	console.log('point_i', point_i)
		//	console.log(P2SPos[point_i])
		//	continue
		//}
